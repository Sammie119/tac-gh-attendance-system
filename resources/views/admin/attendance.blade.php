...
@endsection
@section('button')
    <a href="#addnew" data-toggle="modal" class="btn btn-success btn-sm btn-flat"><i class='fa fa-cog'></i> Generate</a>
    <a href="{{ route('attendance') }}" class="btn btn-danger btn-sm btn-flat"><i class='fa fa-undo'></i> Clear</a>
@endsection
