...
Route::group(['middleware' => ['auth', 'Role'], 'roles' => ['admin']], function () {
    Route::get('/users', '\App\Http\Controllers\Auth\RegisterController@index')->name('users');
    Route::get('/register', '\App\Http\Controllers\Auth\RegisterController@users')->name('register');
    Route::get('/register_edit/{id}', '\App\Http\Controllers\Auth\RegisterController@edit')->name('register_edit');
    Route::put('/register', '\App\Http\Controllers\Auth\RegisterController@update')->name('register');
    Route::post('/register', '\App\Http\Controllers\Auth\RegisterController@create')->name('register');
    Route::get('/register_delete/{id}', '\App\Http\Controllers\Auth\RegisterController@destroy')->name('register_delete');
